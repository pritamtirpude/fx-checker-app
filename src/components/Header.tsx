...
function Header() {
  return (
    <div className="flex items-center justify-between p-4 md:px-6 md:py-5">
      <div>
        {/*
          Inlined (rather than <img src="/assets/images/logo.svg">) so the
          "fx checker" text can use currentColor and follow the same
          fx-neutral-50 token as the rest of the app's text — the source
          asset hardcodes it to white, which is invisible against the light
          theme's near-white surfaces. The lime mark keeps its literal brand
        ...
        */}
        <svg
          ...
          fill="none"
          viewBox="0 0 139 26"
          className="text-fx-neutral-50 h-5 w-25 md:h-auto md:w-auto"
          role="img"
          aria-label="fx checker logo"
        >
          <path
            fill="#cef739"
            fillRule="evenodd"
